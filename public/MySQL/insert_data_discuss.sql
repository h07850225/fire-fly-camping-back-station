...
VALUES(1,1,'我好像看到恐龍','阿看錯了，是你媽經過啦','2022-09-28 13:25:01',1,null,1),
      ...
      (5,5,'露營時的菜單有什麼，大家來說說吧','喜愛露營的朋友，想必每次露營都有一定要端出來的拿手好菜吧，歡迎大家分享自己的拿手菜，我個人一定會準備:奶油、櫛瓜、杏包菇、牛排、鮭魚，牛排和鮭魚基本上只要簡單煎一煎就很好吃了，奶油還可以拿來炒杏包菇，大家快來分享自己的露營菜單吧!','2022-09-29 20:11:37',1,null,3),
	  (6,6,'營火叢太爛了吧','想問一下路怎麼走，服務人員竟然過0.3秒才回我，服務態度太差了吧，詛咒你們全家都得香港腳。','2022-09-30 17:35:16',1,null,3);
...
UPDATE  discuss
SET discuss_post_time = '2022-09-28 15:04:20'
WHERE discuss_no = 2;

UPDATE  discuss
SET discuss_post_time = '2022-09-29 14:32:29'
WHERE discuss_no = 3;

UPDATE  discuss
SET discuss_post_time = '2022-09-29 16:18:34'
WHERE discuss_no = 4;

UPDATE  discuss
SET discuss_post_time = '2022-09-29 20:11:37'
WHERE discuss_no = 5;

UPDATE  discuss
SET discuss_post_time = '2022-09-30 17:35:16'
WHERE discuss_no = 6;
